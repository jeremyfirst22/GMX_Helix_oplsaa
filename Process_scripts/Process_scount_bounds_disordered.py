...
saveDir='figures'
outname='%s/disordered_helicity.png'%saveDir
outname2='%s/disordered_average_helicity.png'%saveDir
...
fig, axarr = plt.subplots(figRows, figCols, sharex='col',sharey='row', figsize=(6.5,3.0)) 
...
fig2.text(right,top-(top-bottom)/6 ,          r"2 restraints",ha='left',va='center',rotation=270) 
fig2.text(right,top-(top-bottom)/2,           r"1 restraint",ha='left',va='center',rotation=270) 
fig2.text(right,(top-bottom-hspace)/6+bottom, r"no restraints",ha='left',va='center',rotation=270) 
